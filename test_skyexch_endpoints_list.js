...
async function testEndpointsList() {
  ...
  const endpoints = [
    'queryPremiumCricketMarkets',
    'queryPremiumSportsBookMarkets',
    'queryPremiumMarkets',
    'querySportsBookSelections',
    'querySportsBookEventInfo',
    'querySportsBookMarketInfo',
    'querySportsBookMatch',
    'querySportsBookOdds',
    'querySportsBookRunners',
    'querySportsBookPrice',
    'querySportsBookMarketGroup',
    'querySportsBookEventGroup'
  ];
...
testEndpointsList().catch(console.error);
