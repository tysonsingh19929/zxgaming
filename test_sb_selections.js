...
async function testSbSelections() {
  const eventId = '35938017';
  
  for (const ep of ['querySportsBookMarket', 'querySportsBookSelections', 'querySportsBookMarketSelections', 'querySportsBookOdds']) {
...
testSbSelections().catch(console.error);
