...
async function testSbEndpoints2() {
  const eventId = '35938017';
  
  for (const ep of [
    'querySportsBookData', 'querySportsBookEventWithMarket', 'querySportsBookMarketInfo',
    'querySportsBookLive', 'querySportsBookOddsInfo', 'querySportsBookRates',
    'querySportsBookMarketSelection', 'querySportsBookList', 'querySportsBook'
  ]) {
...
testSbEndpoints2().catch(console.error);
