async function debugFancyBallRun() {
  ...
  const f19 = list.find(f => f.marketName && f.marketName.includes('19 Over ABF'));
  console.log('--- RAW 19 Over ABF OBJECT ---');
  console.log(JSON.stringify(f19, null, 2));
}

debugFancyBallRun().catch(console.error);
