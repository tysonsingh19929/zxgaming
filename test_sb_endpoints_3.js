...
async function testSbEndpoints3() {
  const eventId = '35938017';
  
  for (const ep of [
    'querySportsBookMarketSelectionList', 'querySportsBookSelectionList',
    'querySportsBookMarketsWithSelection', 'querySportsBookMarketAndSelection',
    'querySportsBookInfo', 'querySportsBookItems', 'querySportsBookDetail'
  ]) {
...
testSbEndpoints3().catch(console.error);
